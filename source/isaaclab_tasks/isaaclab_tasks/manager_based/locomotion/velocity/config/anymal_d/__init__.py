...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_dppo_cfg_entry_point": f"{agents.__name__}.rsl_rl_dppo_cfg:AnymalDFlatDppoRunnerCfg",
...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_dppo_cfg_entry_point": f"{agents.__name__}.rsl_rl_dppo_cfg:AnymalDRoughDppoRunnerCfg",
